...
static lv_i18n_phrase_t en_us_singulars[] = {
    ...
    {"statistics_avg_current_per_second", "Average current per second"},
    {"statistics_avg_current_per_minute", "Average current per minute"},
    {"statistics_avg_currnet_total", "Total average current"},
    {"statistics_rtc_time", "RTC statistical time"},
    {"statistics_instant_peak_currnet", "Instantaneous peak current"},
    {"statistics_minimum_no_zero_currnet", "Minimum non-zero current"},
